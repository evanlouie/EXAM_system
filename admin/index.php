...
if (isset($_GET['exam_id'])) {
	...
	while (!empty($sections)) {
		...
		$includedSections .= "<tr class='entry'>
								<td class='editButtonCell'><img class='editExamButton' src='editbutton.png' alt='Edit Button' height='15' width='15' /></td>
								<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
<td class='includedSection' value='" . $section -> get_section_id() . "'>" . $section -> get_title() . "</tr>";
	...
	while (!empty($sections)) {
		...
		$excludedSections .= "<tr class='entry'><td class='editEntryCell'><img class='editEntryButton' src='editButton2.png' alt='Edit Button' height='15' width='15'/></td><td class='excludedSection' value='" . $section -> get_section_id() . "'>" . $section -> get_title() . "</tr>";
	}
}
...
if (isset($_GET['exam_id']) && isset($_GET['section_id'])) {
	...
	while (!empty($includedQuestionArray)) {
		...
		// $includedQuestions .= "<li class='includedQuestion' value='" .
		// $question->get_question_id () . "'>" . $question->get_question () .
		// "</li>";
		$includedQuestions .= "<tr class='entry'>
			<td class='editButtonCell'><img class='editSectionButton' src='editButton.png' alt='Edit Button' height='15' width='15' /></td>
			<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
			<td class='includedQuestion' Value='" . $question -> get_question_id() . "'>" . $question -> get_question() . "</tr>";
	}
	...
	while (!empty($excludedQuestionArray)) {
		...
		$excludedQuestions .= "<tr class='entry'>
			<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
			<td class='excludedQuestion' Value='" . $question -> get_question_id() . "'>" . $question -> get_question() . "</tr>";
	}
...
if (isset($_GET['sectionQuestionIncorrectAnswer']) && isset($_GET['section_id']) && isset($_GET['question_id'])) {
	...
	while (!empty($includedIncorrectAnswersArray)) {
		...
		if ($sqam -> answer_id == $answer -> answer_id) {
			$includedIncorrectAnswers = $includedIncorrectAnswers . "<tr class='entry'>
			<td class='editButtonCell'><input type='radio' name='answers' checked='yes' class='includedIncorrectAnswer' value='" . $answer -> get_answer_id() . "'></td> 
			<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
			<td class='includedIncorrectAnswerCell' value='$answer->answer_id'>" . $answer -> get_answer() . "</td>
			</tr>";
		} else {
			$includedIncorrectAnswers = $includedIncorrectAnswers . "<tr class='entry'>
			<td class='editButtonCell'><input type='radio' name='answers' class='includedIncorrectAnswer' value='" . $answer -> get_answer_id() . "'></td>
			<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
			<td class='includedIncorrectAnswerCell' value='$answer->answer_id'>" . $answer -> get_answer() . "</td>
			</tr>";
		}
	...
	while (!empty($excludedIncorrectAnswersArray)) {
		...
		$answer = new answer();
		$answer -> getFromDB($a -> answer_id);
		$excludedIncorrectAnswers = $excludedIncorrectAnswers . "<tr class='entry'>
		<td class='editEntryCell'><img class='editEntryButton' src='editbutton2.png' alt='Edit Button' height='15' width='15' /></td>
		<td class='excludedIncorrectAnswer' value='" . $answer -> get_answer_id() . "'>" . $answer -> get_answer() . "</td>
		</tr>";
	}
}
					...
					<code id="maker">
						<table style="width: 100%">
							<tr>
								<td>Create Exam:</td>
								<td>
								<input type="text" id="newExam" value="Title" />
								</td>
								<td>
								<button id="createExam">
									Create
								</button></td>
							</tr>
							<tr>
								...
								<td>
								<input type="text" id="newSection" value="Title" />
								</td>
								<td>
										...
										<tbody>
											...
											<tr>
												...
												id="chosenSectionToEdit" style="width: 100%">
													<?php
													if (isset($includedSectionsOptionItems)) {echo $includedSectionsOptionItems;
													} else
														echo '';
													?>
												</select></td>
